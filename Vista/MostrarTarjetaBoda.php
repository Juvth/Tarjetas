...
<div class="container-fluid">
    ...
    <div class="title-table col-12">
        <p class>Datos de Tarjetas de Boda</p>
    </div>

    <div class="datos">
        <form action="Admin.html" id="frmRTarjetaBautizo" method= "POST">           
            <table class="table col-lg-auto" border="1">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col">NOMBRE_NOVIO</th>
                ...
                <tbody>
                    <?php include("../Modelo/MostrarTBoda.php");?>
                </tbody>
            </table>      
        </form>
    </div>
