...
$sql="INSERT into trj_boda(nombre_Novio,nombre_Novia,id_boda,fecha,hora,padrinos,cedula_cliente) values ('$nombre_Novio','$nombre_Novia','$id_boda','$fechaBoda','$horaBoda','$padrinosBoda','$cedula')";
