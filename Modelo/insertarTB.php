...
$sql="INSERT into trjbautizo(id_bautizo,iglesia,recepcion,edad,nombre,padrinos,fecha,hora,cedula_cliente)
values ('$idBautizo','$iglesia','$recepcion','$edad','$nombreTB','$padrinos','$fechaTB','$horaTB','$cedula')";
