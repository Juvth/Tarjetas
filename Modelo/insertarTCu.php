...
$sql="INSERT into trj_cumple(nombre_cumple,id_cumple,direccion,edad,fecha,hora,cedula_cliente) values ('$nombre_cumple','$id_cumple','$direccionTCu','$edadTCu','$fechaTCu','$horaTCu','$cedula')";
