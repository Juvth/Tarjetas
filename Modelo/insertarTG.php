...
$sql="INSERT into trj_grado(id_grado,direccion,fecha,hora,descripcion,Nombre_grado,cedula_cliente) values ('$id_grado','$direccionTG','$fechaTG','$HoraTG','$descripcionTG','$Nombre_grado','$cedula')";
